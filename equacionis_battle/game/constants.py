...
STATE_INPUT            = "input"
STATE_DEFENSE_INPUT    = "defense_input"
STATE_PLAYER_ATTACK    = "player_attack"
STATE_BOSS_ATTACK      = "boss_attack"
STATE_MESSAGE          = "message"
STATE_RESTART_BATTLE   = "restart_battle"
...
# Sprites usam 3 poses principais: idle, attack e hurt.
...
POS_HP_BOSS    = (20, 40)
POS_HP_PLAYER  = (500, 280)
POS_BOSS       = (480, 65)   # canto superior direito da arena
POS_PLAYER     = (115, 270)  # inferior esquerdo da arena
POS_PLAYER_PLATFORM = (32, 410, 335, 82)
